...
showAnswerButton.addEventListener('click', () => {
    let answerBox = document.querySelectorAll('.showAnswer');
    let correctAnswerButton = document.querySelector('.response');
    setTimeout(function () {
        //answerBox.style.visibility = 'visible';
        //answerBox.style.zIndex = '100';
        correctAnswerButton.forEach(answerBox =>{
            if (answerBox.innerText === answerBox.innerText){
                correctAnswerButton.style.backgroundColor = 'orange';
                console.log(answerBox.innerText);
                console.log(correctAnswerButton.innerText);
        }
        })
        ...
        //Hide the answer
        setTimeout(function () {
            correctAnswerButton.style.backgroundImage = 'linear-gradient(rgb(173, 202, 9), rgb(57, 14, 214))'
