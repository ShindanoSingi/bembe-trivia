...
showAnswerButton.addEventListener('click', () => {
    ...
    setTimeout(function () {
        if (response1.innerHTML === answerBox.innerHTML) {
                response1.style.backgroundImage = 'linear-gradient(rgb(173, 202, 9), rgb(57, 14, 2))'
            }
        if (response2.innerHTML === answerBox.innerHTML) {
                response2.style.backgroundImage = 'linear-gradient(rgb(173, 202, 9), rgb(57, 14, 2))'
        }
        if (response3.innerHTML === answerBox.innerHTML) {
                response3.style.backgroundImage = 'linear-gradient(rgb(173, 202, 9), rgb(57, 14, 2))'
        }
        if (response4.innerHTML === answerBox.innerHTML) {
                response4.style.backgroundImage = 'linear-gradient(rgb(173, 202, 9), rgb(57, 14, 2))'
            }
